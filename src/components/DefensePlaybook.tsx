  ...
  return (
    ...
    >
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 16 }}>
        ...
        <span style={{ fontSize: 12, color: progress === 100 ? '#22c55e' : 'var(--text-muted)' }}>
      ...
      <div style={{
        ...
        <motion.div
          ...
          style={{ height: '100%', background: 'var(--gradient-safe)', borderRadius: 2 }}
        />
      </div>
        ...
        {ACTIONS.map((action, i) => (
          <motion.button
            ...
            style={{
              ...
              background: checked.has(i) ? 'rgba(34,197,94,0.03)' : 'transparent',
              border: '1px solid',
              borderColor: checked.has(i) ? 'rgba(34,197,94,0.15)' : 'transparent',
