...
export default function Navbar({ onHistoryClick, historyCount, view, onViewChange }: NavbarProps) {
  ...
  return (
    <motion.nav
      ...
      style={{
        ...
        background: 'rgba(11, 11, 18, 0.75)', backdropFilter: 'blur(20px)',
      ...
      <div style={{ maxWidth: 1000, margin: '0 auto', height: 64, display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        ...
        <a href="#" onClick={(e) => { e.preventDefault(); onViewChange('home'); window.scrollTo({ top: 0, behavior: 'smooth' }); }}
          ...
          <span style={{ fontSize: 18, fontWeight: 700, letterSpacing: '-0.02em' }}>
            Mirror<span style={{ color: 'var(--accent-purple)' }}>Trap</span>
          </span>
        </a>
  ...
  return (
    <a href={href} onClick={(e) => { e.preventDefault(); onClick(); }}
      style={{
        ...
        background: active ? 'rgba(168,85,247,0.08)' : 'none',
        border: `1px solid ${active ? 'rgba(168,85,247,0.15)' : 'transparent'}`,
